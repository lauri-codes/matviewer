System.register(["./viewer"], function (exports_1, context_1) {
    "use strict";
    var viewer_1, BrillouinZoneViewer;
    ...
    return {
        ...
        execute: function () {
             ...
             */
            BrillouinZoneViewer = class BrillouinZoneViewer extends viewer_1.Viewer {
                constructor() {
                    super(...arguments);
                    this.fitMargin = 0.018; // The scene containing the information that is overlayed on top of the BZ
                }
                /*
                ...
                createBrillouinZone(vertices, faces, basis, segments, labels) {
                    ...
                    function createAxisLabel(position, label) {
                        // Configure canvas
                    ...
                    let labelMap = {};
                    let labelPositions = [];
                    function generateSymmPoint(position, label) {
                        // Configure canvas
                        let canvas = document.createElement('canvas');
                        let size = 256;
                        canvas.width = size;
            ...
            exports_1("BrillouinZoneViewer", BrillouinZoneViewer);
        }
    };
});
